...
const TodayAllocation = () => {
  ...
  const TableData = [
    ...
    {id: 6, name: 'Diksha Agrawal', status: 'Done'},
    {id: 7, name: 'Sakshi Patil', status: 'Pending'},
    {id: 8, name: 'Aaysha Yadav', status: 'Done'},
    {id: 9, name: 'Anuj Petkar', status: 'Done'},
    {id: 10, name: 'Saurabh Wagh', status: 'Pending'},
  ];
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        />
        <Text style={styles.backIconText}>Today’s Allocation</Text>
      </TouchableOpacity>
...
export default TodayAllocation;
